...
new_class = '''class IBBroker:
    ...
    def buy(self, ticker: str, qty: int, limit_price: float = None):
        ...
        if is_rth:
            ...
            # Add $0.03 of allowable slippage to aggressively fill the limit order
        ...
        try:
            ...
            # Wrap in OrderResult to preserve existing structure compatibility
    ...
    def sell(self, ticker: str, qty: int, limit_price: float = None):
        ...
        if is_rth:
            ...
            # Subtract $0.03 of allowable slippage to aggressively dump the shares
...
# Find the IBBroker class and replace it up to def get_broker()
